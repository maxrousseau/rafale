...
def iterative_debug(rafale_model, hf_model, tokenizer=None, layer=0):
    ...
    try:
        ...
        print("❌ INPUTS pre-attention norm difference")
    ...
    try:
        ...
        print("❌ pre-attention norm difference")
    ...
    try:
        ...
        print(f"❌ error with attention in-projection")
    ...
    try:
        ...
        print("❌ error with outputs of attention")
